    ...
    >
      ...
      >
        <div className="flex justify-between items-center"> 
          ...
          <a href="/resume/Resume_hitesh.pdf" download="HiteshBidwawatkaResume" target="_blank" rel="noopener noreferrer" className="p-2 bg-[#915EFF] font-bold text-white rounded-xl">
            Download Resume
          </a>
        </div>
