...
const ServiceCard = ({ index, title, icon }) => (
  ...
  >
    <motion.div
      ...
      className="w-full border-green-pink-gradient bg-[#151030] border-2 p-[1px] rounded-[20px] shadow-card"
    >
...
const About = () => {
  return (
    <>
      ...
      <div className='relative mt-10 w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6'>
